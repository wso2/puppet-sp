...
# Class: sp_dashboard_master
# Init class of stream processor dashboard profile
class sp_dashboard_master inherits sp_dashboard_master::params {
  ...
  /*
    ...
    Note: Ensure
    that file is available in modules -> sp_dashboard_master -> files
  */
