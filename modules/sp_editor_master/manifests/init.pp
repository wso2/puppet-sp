...
# Class: sp_editor_master
# Init class of stream processor - Editor profile
class sp_editor_master inherits sp_editor_master::params {
  ...
  /*
    ...
    Note: Ensure
    that file is available in modules -> sp_editor_master -> files
  */
